...
def compareWordsSameLength(word1, word2):
...
def compareWordsDifferentLength(word1, word2):
...
def compareWords(word1, word2, markSpaces = True):

    newWord1 = word1.strip().replace(" ", "·")
    newWord2 = word2.strip().replace(" ", "·")

    if len(newWord1) == len(newWord2):
        finalWords = compareWordsSameLength(newWord1, newWord2)
    else:
        finalWords = compareWordsDifferentLength(newWord1, newWord2)
