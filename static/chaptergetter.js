...
const chapterDropdown = document.getElementById("chapterSelectionDropdown");
...
bookDropdown.addEventListener("change", () => {
    ...
    const chapterCount = bookToChapterDictionary[selectedBook];
